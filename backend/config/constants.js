...
export const GAME_CONFIG = {
  RACE_INITIAL_POINTS: Number(process.env.RACE_INITIAL_POINTS) || 30000,
  RACE_POINTS_DECREMENT_PER_SECOND: Number(process.env.RACE_POINTS_DECREMENT_PER_SECOND) || 50
};